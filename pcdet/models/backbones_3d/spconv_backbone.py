...
class VoxelResBackBone8x_LDFCNet(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        super().__init__()
        self.model_cfg = model_cfg
        use_bias = self.model_cfg.get('USE_BIAS', None)
        ...
        self.conv_input = spconv.SparseSequential(
            spconv.SubMConv3d(32, 32, 3, padding=1, bias=False, indice_key='subm1'),
            norm_fn(32),
            nn.ReLU(),
        )
        block = post_act_block
        ...
        self.conv2 = spconv.SparseSequential(
            ...
            SparseBasicBlock(64, 64, bias=use_bias, norm_fn=norm_fn, indice_key='res2'),
            SparseBasicBlock(64, 64, bias=use_bias, norm_fn=norm_fn, indice_key='res2'),
        )
        ...
        self.conv3 = spconv.SparseSequential(
            ...
            SparseBasicBlock(128, 128, bias=use_bias, norm_fn=norm_fn, indice_key='res3'),
            SparseBasicBlock(128, 128, bias=use_bias, norm_fn=norm_fn, indice_key='res3'),
        )
